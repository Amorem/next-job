...
type UserSelectionType = "company" | "job seeker";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4">
        <Button
          ...
          variant={"outline"}
          className="w-full size-auto p-6 items-center gap-4 border-2 transition-all duration-200 hover:border-primary hover:bg-primary/5"
        >
